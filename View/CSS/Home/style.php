...
/* 
.hr-js{
    position: absolute; background-color: black; height: 2px; width: 90px; top: -1px;
} */
...
div.volume-fl{
    width: 23%; display: flex; align-items: center; justify-content: flex-end;
}
...
<style>
        ...
        a.hover-2027-xxx:active .parent-list-down-all-2027{
            display: block;
            background-color: red;
        }

        .parent-list-down-all-2027 .list-nav-2027{
            padding: 15px 20px;
            display: flex;
            gap: 40px;
            align-items: center;
        }
        .parent-list-down-all-2027 .list-nav-2027:hover{
            background-color: rgba(0, 0, 0, 0.183);
            border-radius: 10px;
        }
        .parent-list-down-all-2027 .list-nav-2027 .children-2027{
            display: flex;
            align-items: center;
            gap: 10px;
        }
        .parent-list-down-all-2027 .list-nav-2027 .children-2027 i{
            font-size: 25px;
        }
        .parent-list-down-all-2027 .list-nav-2027 .children-2027 span{
            font-weight: 500;
            font-size: 18px;
        }
        .parent-list-down-all-2027 .list-nav-2027 .children02-2027{
            display: flex;
            align-items: center;
            gap: 5px;
        }
        .parent-list-down-all-2027 .list-nav-2027 .children02-2027 i{
            font-size: 25px;
        }
        .parent-list-down-all-2027 .list-nav-2027 .children02-2027 span{
            font-size: 18px;
        }
</style>
...
<style>
        ...
        .notice-choose-admin-container .bodyv{
            text-align: center;
            margin: 30px;
            padding: 10px 30px;
            border-radius: 15px;
        ...
        .notice-choose-admin-container .bodyv .present{
            width: 90px;
            height: 90px;
            overflow: hidden;
            border-radius: 50%;
        ...
        .notice-choose-admin-container .bodyv .main-present{
            font-weight: bold;
            font-size: 25px;
        }
        .notice-choose-admin-container .bodyv .present img{
            width: 100%;
            height: 100%;
        }
        .notice-choose-admin-container .title-111{
            display: flex;
            align-items: center;
            justify-content: center;
        }
        .notice-choose-admin-container .title-111 .bx-x{
            font-size: 35px;
            color: gray;    
        }
        .notice-choose-admin-container .title-111 .text-xxx{
            font-size: 22px;
        }
        .notice-choose-admin-container .bodyv .inf-admin{
            display: flex;
            column-gap: 10px;
            align-items: center;
            justify-content: space-between;
        ...
        .notice-choose-admin-container .bodyv .inf-admin .chietxuatvnaanh{
            display: flex;
            width: 45%;
            justify-content: space-between;
        }
        .notice-choose-admin-container .bodyv .inf-admin .chietxuatvnaanh .thunhat-78{
            position: relative;
        }
        .notice-choose-admin-container .bodyv .inf-admin .chietxuatvnaanh .thuhai-78{
            position: absolute;
            margin-left: 25px;
        }
        .notice-choose-admin-container .bodyv .inf-admin .chietxuatvnaanh .thuba-78{
            position: absolute;
            margin-left: 50px;
        }
        .notice-choose-admin-container .bodyv .inf-admin .chietxuatvnaanh div{
            width: 35px;
            height: 35px;
            overflow: hidden;
            border-radius: 50%;
        }
        .notice-choose-admin-container .bodyv .inf-admin .chietxuatvnaanh div img{
            width: 100%;
            height: 100%;
        }
        .notice-choose-admin-container .click-get-choo{
            display: flex;
            justify-content: space-between;
            margin: 0 30px;
        }
        .notice-choose-admin-container .click-get-choo .anana{
            width: 47%;
            height: 60px;
            border-radius: 10px;
            border: none;
        ...
        .notice-choose-admin-container .click-get-choo button.anana{
            border: 2px solid blue;
            font-weight: 700;
            color: blue;            
            background-color: rgb(253, 253, 253);
        }
        .notice-choose-admin-container .click-get-choo form input{
           width: 100%;
           height: 100%;
           border-radius: 10px;
           border: none;
        ...
        .notice-choose-admin-container .bodyv .inf-admin .chuyenhoa .righxx{
            text-align: left;
        }
        .question-admin{
            font-size: 18px;
